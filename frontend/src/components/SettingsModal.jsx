...
import { Modal, Form, Input, Tabs, message, Button, Alert, Image } from 'antd'
  ...
  const items = [
    {
      ...
      children: (
        <div>
          <Alert
            message="SessionId 获取说明"
            description={
              <div>
                <p style={{ marginBottom: 12 }}>登录即梦官网，按F12按键打开浏览器开发者工具</p>
          ...
          <Alert
            ...
            description={
              <div>
                ...
                <p>5. 点击创建 API Key</p>
                <p style={{ color: '#666', fontSize: 13 }}>6. （可选）编辑权限，选择自定义权限，选择以下模型即可：</p>
                <div style={{ marginTop: 8, padding: '8px 12px', background: '#f0f5ff', borderRadius: 4 }}>
                  <p style={{ margin: 0, fontSize: 13 }}>• Doubao-Seedream-5.0-lite</p>
                  <p style={{ margin: '4px 0 0 0', fontSize: 13 }}>• Doubao-Seedream-4.5</p>
                </div>
                <div style={{ marginTop: 12, textAlign: 'center' }}>
                  <Image
                    src={apiKeyImg}
